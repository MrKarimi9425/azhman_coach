...
import { removeAuth_Key } from '../Storage/Async';
import { useNavigation } from '@react-navigation/native';
import { drawerData } from '../Components/Common/dataArray';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flex: 1, backgroundColor: '#fff', paddingTop: 10 }}>
                {
                    drawerData.map((value, index) => <Ripple onPress={() => navigate(value.screen)}
            ...
            <View style={{ padding: 20, borderTopWidth: 1, borderTopColor: '#ccc' }}>
                <TouchableOpacity onPress={() => {
                    Alert.alert(
                        ...
                        [
                            ...
                            },
                            {
                                text: "بله همین الان!",
                                onPress: () => {
                                    removeAuth_Key('@auth_key').then(value => {
                                        if (value) {
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
                        ...
                        <Ionicons name="exit-outline" style={{ fontSize: RFValue(20) }} />
                    </View>
                </TouchableOpacity>
            </View>
        </View>
